...
// }
    ...
    $query = mysqli_query($conn, "Select group_chats.*, users.name from group_chats , users where (group_chats.group_id='$group_id' and users.id=group_chats.user_id )order by group_chats.date_time");
